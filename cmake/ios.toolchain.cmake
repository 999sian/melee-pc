...
find_program(CMAKE_C_COMPILER NAMES clang-19 clang)
find_program(CMAKE_CXX_COMPILER NAMES clang++-19 clang++)
find_program(CMAKE_OBJC_COMPILER NAMES clang-19 clang)
find_program(CMAKE_OBJCXX_COMPILER NAMES clang++-19 clang++)
...
set(IOS_COMMON_FLAGS "--target=${IOS_TARGET_TRIPLE} -march=armv8-a -mbranch-protection=none -fno-asynchronous-unwind-tables -fno-unwind-tables -mno-outline-atomics -isysroot ${IOS_SDK_PATH} -D__APPLE__=1 -DTARGET_OS_IPHONE=1 -DTARGET_OS_IOS=1")
...
set(CMAKE_EXE_LINKER_FLAGS_INIT "--target=${IOS_TARGET_TRIPLE} -isysroot ${IOS_SDK_PATH} -fuse-ld=lld -Wl,-no_compact_unwind")
set(CMAKE_SHARED_LINKER_FLAGS_INIT "--target=${IOS_TARGET_TRIPLE} -isysroot ${IOS_SDK_PATH} -fuse-ld=lld -Wl,-no_compact_unwind")
