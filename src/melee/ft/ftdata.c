...
{
    /* The decomp reached ft_8045993C by walking past gFtDataList. */
    (void) list;
...
{
    ftData** list;
    /* The decomp reached these two tables by walking past
     * CostumeListsForeachCharacter; they are the anim-archive caches. */
