...
HSD_JObj* it_802A2568(Item* arg0, HSD_JObj* arg1, s32 arg2, f32 arg8)
{
    ...
    attr = DP(itLinkHookshotAttributes, arg0->xC4_article_data->x4_specialAttributes);
...
bool itLinkhookshot_UnkMotion8_Anim(Item_GObj* arg0)
{
    ...
    attr = DP(itLinkHookshotAttributes, item->xC4_article_data->x4_specialAttributes);
...
void it_802A2EE4(Item_GObj* arg0)
{
    ...
    Item* item = GET_ITEM(arg0);
    itLinkHookshotAttributes* attr =
        DP(itLinkHookshotAttributes, item->xC4_article_data->x4_specialAttributes);
