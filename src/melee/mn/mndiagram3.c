...
{
    return HSD_JObjLoadJoint(DP(HSD_Joint, archive->joint));
}
...
void mnDiagram3_Create(int arg0)
{
    ...
    HSD_JObjAddAnimAll(jobj, DP(HSD_AnimJoint, archive->animjoint), DP(HSD_MatAnimJoint, archive->matanim_joint),
                       DP(HSD_ShapeAnimJoint, archive->shapeanim_joint));
                                               ...
                                               StaticModelDesc* archive)
{
    ...
    HSD_JObjAddAnimAll(popup_jobj, DP(HSD_AnimJoint, archive->animjoint), DP(HSD_MatAnimJoint, archive->matanim_joint),
                       DP(HSD_ShapeAnimJoint, archive->shapeanim_joint));
