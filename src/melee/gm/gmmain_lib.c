...
{
    /* Port 5 is past the end of `rumble_enabled[PAD_MAX_CONTROLLERS]`; the
     * byte it happened to land on is `deflicker`, which is what this getter
     * pairs with (see gmMainLib_8015F4F4). Name the field. */
