...
/* 19027C */ void fn_8019027C(DiscU32* lights);
/* 1902F0 */ void fn_801902F0(HSD_GObj* sis_gobj);
...
/* 1963B4 */ void gm_Scene_TouSetup_OnEnter(UNK_T);
/* 1964A4 */ void gm_Scene_TouSetup_OnExit(UNK_T);
