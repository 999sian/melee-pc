...
void vi0501_Scene_OnEnter(void* arg)
{
    ...
    fog = HSD_FogLoadDesc(vi_SceneFogDesc(un_804D6F70));
    ...
    lobj = lb_80011AC4(DP(DiscU32, un_804D6F70->lights));
    ...
    for (i = 0; vi_SceneModel(un_804D6F70, i) != NULL; i++) {
        DynamicModelDesc* model = vi_SceneModel(un_804D6F70, i);
