...
void vi1101_Scene_OnEnter(void* arg)
{
    ...
    HSD_GObjObject_80390A70(temp_r28, HSD_GObj_LightKind & 0xFFFF,
                            lb_80011AC4(DP(DiscU32, un_804D6FC0->lights)));
